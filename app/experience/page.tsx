        ...
        <div className="bg-pistachio p-8 w-full rounded-lg">
          ...
          <FadeIn>
            <div className="flex flex-col my-2 w-full">
              ...
              <div className="pl-4">
                <p className="text-base">
                  Summer 2024 semester abroad, studying Korean language,
                  culture, and history and engaging in immersive cultural
                  experiences to enhance language skills and deepen cultural
                  understanding.
                </p>
              </div>
            </div>
